...
class Botao extends Component {
  ...
  render() {
    return (
      <TouchableOpacity style={this.styles.botao} onPress={this.props.action}>
...
export default class AppBiscoitoDaSorte extends Component {

  constructor (props) {
    super(props)
    this.state = {texto: 'Frase da sorte'}
    this.frases = [
  ...
  render() {
    ...
    return(
      <View style={styles.area} >
        <Text style={styles.titulo} >App Biscoito da Sorte</Text>
        <View style={{flex: 5, justifyContent: 'center', alignItems: 'center'}} >
          <Image source={require('./images/cookie.png')} />
          <Text style={styles.texto} >{this.state.texto}</Text>
          <Botao color='#B59619' text='Quebrar Biscoito' action={this.quebrarBiscoito} />
        </View>
      </View>
    )
  }
